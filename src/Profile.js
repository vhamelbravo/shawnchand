  ...
  return (
    <>
      <div className="md:pl-[10%] flex justify-start md:translate-y-[10%]">
        <div className="text-white w-[95%] md:m-none m-auto md:max-w-[63%] profile border border-slate-400  pb-[5rem] md:pl-[12%] min-h-[480px] ">
          <div className="reative">
            ...
            <img
              className="md:hidden absolute top-50 left-0 h-[120px] w-[120px]"
              src={image}
            />
          </div>
          <p className="max-h-[50%] overflow-y-scroll m-auto w-[880px] md:max-w-[100%] intro-text text-white  translate-y-[5%] ">
          ...
          <p className="max-w-[100%] relative facts text-3xl translate-y-[60%] flex justify-start translate-x-[-20%]">
            {" "}
          ...
          <ul className="max-w-[100%] flex flex-col items-start translate-x-[-23%] translate-y-[30%]">
            <li>
              {" "}
              <p className="max-w-[100%] facts-text facts-1 text-white">
                - Proudly hailing from Canada.
              </p>{" "}
            </li>
            <li>
              {" "}
              <p className="max-w-[100%] facts-text facts-2 text-white ">
                - I harbor a deep affection for adorable koalas.
              </p>{" "}
            </li>
            <li>
              {" "}
              <p className="max-w-[100%] facts-text facts-3 text-white ">
                - The fall and winter months hold a special place in my heart.
              </p>
            </li>
            <li>
              {" "}
              <p className="max-w-[100%] facts-text facts-4 text-white">
