...
function Services () {
	...
	<>
		...
		<img className="service-2-img scale-[80%] my-[-41%] mx-[50%]" src={coaching} />
		...
		<img src={coding} className="absolute service-3-img scale-[30%] mx-[-12%] my-[15%] " />
		...
		<img src={planning} className="service-4-img scale-[13%] my-[-52%] mx-[8%] absolute" />
