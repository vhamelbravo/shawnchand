...
function Navbar({ showNav }) {
  ...
  const [visibility, setvisibility] = useState(showNav);
  const toggle = () => {
    setActive(!active);
  };
  ...
  return (
    <div>
      <button
        onClick={handleClick}
        className="fixed top-5  portfolio-button-next text-white text-9xl bg-red-100"
      >
        {" "}
        V{" "}
      </button>
      {visibility && (
        <div
          id="looking" //remove later
          className="flex flex-row justify-end pt-[7.8rem] pr-[5%] h-[30rem]"
        >
          <input type="checkbox" className="navbar-mobile-checkbox hidden" />
          <p className="hidden text-white text-7xl navbar-mobile-button"> v</p>
          <div className="navbar  border-2 border-slate-400 w-[20rem] h-[30rem] ">
            ...
            <ul>
              <li>
                ...
                <Link to="/">
                  {" "}
                  <p className="navbar-links home-link text-white text-3xl translate-y-[50%] translate-x-[20%] hover:underline">
                    {" "}
                    <img
                      src={navHome}
                      className="nav-home-img w-[36px] translate-x-[-112%] absolute"
                    />{" "}
                    Home{" "}
                  </p>{" "}
                </Link>{" "}
              ...
              <li>
                ...
                <Link to="/about">
                  {" "}
                  <p className="navbar-links about-link text-white text-3xl translate-y-[50%] translate-x-[20%] hover:underline">
                    {" "}
                    <img
                      src={navAbout}
                      className="nav-about-img w-[36px] translate-x-[-112%] absolute"
                    />{" "}
                    About{" "}
                  </p>{" "}
                </Link>{" "}
              ...
              <li>
                ...
                <Link to="/services">
                  {" "}
                  <p className="navbar-links services-link text-white 500 text-3xl translate-y-[50%] translate-x-[20%] hover:underline">
                    {" "}
                    <img
                      src={navAbout}
                      className="nav-about-img w-[36px] translate-x-[-112%] absolute"
              ...
              <li>
                {" "}
                <a href="mailto:shawn@shawnjc.ca">
                  {" "}
                  <p className="navbar-links contact text-white text-3xl translate-y-[50%] translate-x-[20%] hover:underline">
                    {" "}
                    <img
                      src={navContact}
                      className="nav-contact-img w-[36px] translate-x-[-112%] absolute"
                    />{" "}
                    Contact{" "}
                  </p>{" "}
                </a>{" "}
              ...
              <div className="socials-container flex justify-end translate-y-[100%] translate-x-[20%] space-evenly">
                ...
                <a href="https://twitter.com">
                  ...
                  <img
                    src={twitter}
                    id="twitter"
                    className="socials twitter h-fit relative w-16 translate-y-[10%] translate-x-[16%]"
                  />{" "}
                </a>
                <a href="https://discord.com/users/150504671033819136">
                  {" "}
                  <img
                    src={discord}
                    className="socials discord h-fit w-16 translate-y-[10%] translate-x-[80%]"
                  />{" "}
                </a>
                <a href="https://linkedin.com/in/shawnjasnalchand">
                  {" "}
                  <img
                    src={linkedin}
                    className="socials linkedin h-fit relative w-16 translate-y-[150.5%] translate-x-[-350.5%] "
                  />{" "}
                </a>
                <a href="https://reddit.com">
                  ...
                  <img
                    src={reddit}
                    className="socials reddit h-fit relative w-16 translate-y-[150.5%] translate-x-[-290.5%] "
                  />{" "}
                </a>
                <a className="h-fit" href="https://tiktok.com">
                  {" "}
                  <img
                    src={tiktok}
                    className="socials tiktok h-fit relative w-16 translate-y-[160.5%] translate-x-[-220.5%] "
                  />{" "}
                </a>
              </div>
            </ul>
