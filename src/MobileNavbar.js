...
const MobileNavbar = () => {
  ...
  return (
    <>
      <div id="mobileNav" className="fixed z-50 sm:hidden px-4 w-[100%] flex justify-center items-center">
        <div className="z-10 overlay block sm:hidden"></div>
        <div className="z-[29] flex flex-row justify-end min-h-[93vh] ">
          <div className="navbar border-2 border-slate-400 w-[100%] lg:w-[20rem]  ">
            ...
            <p className="hidden text-white text-7xl navbar-mobile-button">
              {" "}
              v
            </p>
